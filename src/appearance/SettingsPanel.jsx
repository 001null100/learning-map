...
import { DEFAULT_APPEARANCE, useAppearance } from './AppearanceProvider.jsx';
      ...
      <aside className="settings-panel" role="dialog" aria-modal="true" aria-label="Appearance settings">
        ...
        <div className="settings-scroll">
          ...
          <section className="settings-section">
            ...
            <Segment
              label="Background"
              value={appearance.graphPattern}
              options={[["dots", "Dots"], ["grid", "Grid"], ["cross", "Cross"], ["none", "None"]]}
              onChange={(value) => updateAppearance('graphPattern', value)}
            />
        ...
        <footer className="settings-footer">
          <button type="button" onClick={() => resetAppearance(DEFAULT_APPEARANCE)}>Reset appearance</button>
